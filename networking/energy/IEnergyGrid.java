...
public interface IEnergyGrid extends IGridCache, IEnergyGridProvider
{
	 ...
	 * 
	 * IMPORTANT: Network power knows no bounds, for less spamy power flow,
	 * networks can store more then their alloted storage, however, it should be
	 * kept to a minimum, to help with this, this method returns the networks
	 * current OVERFLOW, this is not energy you can store some where else, its
	 ...
	 * 
	 * Another important not, is that if a network that had hover flow is
